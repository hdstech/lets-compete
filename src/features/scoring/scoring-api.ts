...
// the scoring screen can't resolve answerers via round_participants the way
...
export type JudgeDecision = { answer_id: string; final_correct: boolean }

export async function adjudicateRoundAnswers(
  roundId: string,
  scores: JudgeDecision[],
): Promise<AnswerRow[]> {
